var LineChart = function( options ) {
  ...
  function render() {
    ...
    let progressFragment = ( progress * data.length ) - Math.floor( progress * data.length );
...
function reset() {
  chart.populate([
    { label: 'Mon', i: 0, value: 0 },
    { label: 'Tue', i: 1, value: 100 },
    { label: 'Wed', i: 2, value: 200 },
    { label: 'Thu', i: 3, value: 840 },
    { label: 'Fri', i: 4, value: 620 },
    { label: 'Sat', i: 5, value: 500 },
    { label: 'Sun', i: 6, value: 600 },
